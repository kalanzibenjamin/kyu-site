  ...
  <main class="container" id="main-content">
    <article class="announcement-detail fade-up">
      ...
      <div class="announcement-share" aria-label="Share this announcement">
        <span class="announcement-share-label">Share this update</span>
        <div class="announcement-share-actions">
          <button class="share-btn" type="button" data-platform="native" data-url="${canonicalUrl}" data-title="${escapeHtml(announcement.title)}" data-description="${escapeHtml(description)}" aria-label="Share using your device"><i class="fas fa-share-alt" aria-hidden="true"></i><span>Share</span></button>
          <button class="share-btn" type="button" data-platform="whatsapp" data-url="${canonicalUrl}" data-title="${escapeHtml(announcement.title)}" data-description="${escapeHtml(description)}" aria-label="Share on WhatsApp"><i class="fab fa-whatsapp" aria-hidden="true"></i><span>WhatsApp</span></button>
          <button class="share-btn" type="button" data-platform="telegram" data-url="${canonicalUrl}" data-title="${escapeHtml(announcement.title)}" data-description="${escapeHtml(description)}" aria-label="Share on Telegram"><i class="fab fa-telegram-plane" aria-hidden="true"></i><span>Telegram</span></button>
          <button class="share-btn" type="button" data-platform="copy" data-url="${canonicalUrl}" data-title="${escapeHtml(announcement.title)}" data-description="${escapeHtml(description)}" aria-label="Copy announcement link"><i class="fas fa-link" aria-hidden="true"></i><span>Copy link</span></button>
        </div>
      </div>
    </article>
  </main>
