      ...
      <div class="announcement-share" aria-label="Share this announcement">
        ...
        <div class="announcement-share-group announcement-share-social">
          ...
          <div class="announcement-share-actions">
            ...
            <button class="share-btn share-btn-social" type="button" data-platform="twitter" data-url="${canonicalUrl}" data-title="${escapeHtml(announcement.title)}" data-description="${escapeHtml(description)}" aria-label="Share on X"><i class="fab fa-x-twitter" aria-hidden="true"></i><span>X</span></button>
